        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_230px] lg:items-center">
          <div>
            ...
            <h1 className="mt-4 text-4xl font-black leading-tight">
              5 to 25 Day Placement Roadmap
            </h1>

            <p className="mt-3 max-w-3xl text-sm font-semibold leading-6 text-purple-100">
              Select a role and generate a non-repeating, practical day-wise placement plan.
            </p>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex h-12 items-center gap-2 rounded-xl bg-red-600 px-5 text-sm font-black text-white shadow-lg hover:bg-red-700"
              >
              ...
              <Link
                ...
                className="inline-flex h-12 items-center gap-2 rounded-xl bg-white px-5 text-sm font-black text-purple-700 shadow-lg hover:bg-purple-50"
              >
