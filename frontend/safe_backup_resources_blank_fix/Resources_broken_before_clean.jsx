...
const sections = [
  {
    ...
    ,
      ...
      {
        title: "Web Development YouTube Playlist",
        subtitle: "Project-based web development playlist for placement preparation.",
        type: "YouTube Playlist",
        logo: LOGOS.youtube,
        url: "https://www.youtube.com/results?search_query=web+development+playlist+html+css+javascript+projects"
      },
      {
    ...
    ,
      ...
      {
        title: "React Official Practice Concepts",
        subtitle: "Practice React components, state, props and hooks from official docs.",
        type: "Docs Practice",
        logo: LOGOS.react,
    ...
    ,
      ...
      {
        title: "Backend API Coding Practice",
        subtitle: "Practice APIs, routing, middleware and database integration.",
    ...
    ,
      ...
      {
        title: "Kaggle ML Practice",
        subtitle: "Hands-on machine learning exercises and datasets for practice.",
        type: "Coding Practice",
        logo: LOGOS.kaggle,
    ...
    ,

      {
        ...
        subtitle: "Number system, percentage, profit-loss, time-work and placement aptitude.",
        type: "Practice Questions",
        logo: LOGOS.indiabix,
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        subtitle: "Topic-wise and company-wise DSA coding practice questions.",
        type: "GFG Practice",
        logo: LOGOS.gfg,
      ...
      {
        title: "W3Schools Python DSA Practice",
        subtitle: "Beginner-friendly programming and DSA examples for practice.",
        type: "W3 Practice",
        logo: LOGOS.w3,
...
function getCustomSectionId(category = "", item = {}) {
  ...
  if (
    ...
    combined.includes("computer network") ||
    combined.includes(" cn ") ||
    combined.includes("coa") ||
    combined.includes("computer organization") ||
  ...
  if (
    ...
    combined.includes("takeuforward") ||
    combined.includes("love babbar") ||
    combined.includes("codehelp") ||
    combined.includes("data structure") ||
    combined.includes("algorithm") ||
    combined.includes("coding sheet") ||
    combined.includes("practice sheet")
  ) {
    return "dsa";
  }
  ...
  if (
    ...
    combined.includes("freecodecamp")
  ) {
    return "web";
  }
  ...
  if (
    ...
    combined.includes("nqt") ||
    combined.includes("placement test")
  ) {
    return "aptitude";
  }

  // Courses section only for actual course/paid course resources
  if (
  ...
  // Unknown resources should not pollute Courses.
  return "web";
}
...
export default function Resources() {
  ...
  const visibleSections = useMemo(() => {
    ...
    const mergedSections = sections.map((section) => {
      ...
      // Courses section should show only real course/paid custom resources.
      // No default/manual free resource cards here.
    ...
    // My Resources tab = only add form. Saved cards are already placed in their sections.
    if (active === "custom") {
      return [];
    }
                ...
                card.custom ? (
                  ...
                  >
                    <div className="logo-wrap">
                      <img src={card.logo} alt={card.title} onError={(e) => { e.currentTarget.src = "/resource-logos/youtube.svg"; }} />
                    </div>
