...
export default function CompanyDetail() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 px-6 py-8">
      ...
      <section className="relative overflow-hidden rounded-[36px] bg-gradient-to-br from-slate-950 via-indigo-950 to-violet-900 p-8 text-white shadow-2xl shadow-indigo-100">
