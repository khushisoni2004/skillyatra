...
export default function Dashboard() {
  ...
  const focusMessage = useMemo(() => {
    if (summary.readiness >= 80) return "You are close to final interview-ready stage. Focus on mock interviews, company-specific revision and final resume polish.";
