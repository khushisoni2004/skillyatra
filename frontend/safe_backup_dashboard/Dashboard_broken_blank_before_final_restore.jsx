...
export default function Dashboard() {
  ...
  const priorityCards = [
    ...
    },
    {
      ...
      text: `Today: ${todayLabel}. Streak is synced from backend/progress/local saved records.`,
      icon: CalendarCheck,
      link: "/today"
    },
    {
  ...
  const radarItems = [
    {
      label: "DSA",
      status: summary.dsaDone > 0 ? "In Progress" : "Start Now",
      link: "/dsa"
    },
    {
      label: "Practice MCQs",
      status: summary.practiceDone > 0 ? "In Progress" : "Start Now",
      link: "/practice"
    },
    {
      label: "Resume",
      status: summary.resumeScore > 0 ? "Analyzed" : "Analyze Now",
      link: "/resume"
    },
    {
      label: "Interview",
      status: summary.interviewsDone > 0 ? "Practiced" : "Practice Now",
      link: "/interview"
    }
  ];
  ...
  return (
    <div className="gpsd-page">
      ...
      <div className="gpsd-shell">
        ...
        <section className="gpsd-priority-grid clean-stat-grid">
            ...
            return (
              ...
              >
                <div className="clean-stat-left">
                  <p className="clean-stat-title">{card.title}</p>
                  <h2 className="clean-stat-value">{card.value}</h2>
                </div>
        ...
        <section className="gpsd-content-grid">
          ...
          <div className="gpsd-panel">
            ...
            <div className="gpsd-radar-list">
              {radarItems.map((item) => (
                <Link key={item.label} to={item.link} className="gpsd-radar-row">
                  <p className="gpsd-radar-label">{item.label}</p>
                  <span className="gpsd-radar-status">
                    {item.status}
                    <ArrowRight size={13} />
                  </span>
                </Link>
