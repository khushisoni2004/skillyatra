      ...
      <style>{`
        ...
        * {
        ...
        .bubble {
          position: absolute;
          border-radius: 999px;
          background: radial-gradient(circle at 30% 30%, rgba(255,255,255,0.95), rgba(125,211,252,0.36), rgba(14,165,233,0.14));
        ...
        <section className="visual-card">
          <div className="visual-inner">
            ...
            <p className="visual-desc">
              Track DSA, practice MCQs, improve your resume, and prepare interviews
              with one focused SkillYatra dashboard.
            </p>
