...
export default function Roadmaps() {
  ...
  return (
    <div className="sy-page-theme sy-roadmap-theme min-h-screen bg-[#f7fcff] px-8 py-8">
      <section className="rounded-[2rem] bg-gradient-to-r from-sky-100 via-white to-cyan-100 p-8 text-slate-950 shadow-xl ring-1 ring-sky-100">
        <div className="grid gap-8 lg:grid-cols-[1fr_230px] lg:items-center">
          ...
          <div className="rounded-[1.6rem] bg-white/80 p-6 ring-1 ring-sky-100">
        ...
        <div className="mt-7 h-3 rounded-full bg-sky-100">
          <div
        ...
        <div className="grid gap-5 xl:grid-cols-[1fr_220px_180px] xl:items-end">
          <div>
            ...
            <select
              ...
              className="h-12 w-full rounded-xl border border-slate-200 bg-white px-4 text-sm font-bold text-slate-900 outline-none focus:border-sky-500 focus:ring-4 focus:ring-sky-50"
            >
          ...
          <button
            ...
            className="inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-sky-500 px-5 text-sm font-black text-white shadow-lg shadow-sky-100 hover:bg-sky-600"
          >
      ...
      <section className="mt-8 grid gap-5 md:grid-cols-3">
        ...
        <div className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
          ...
          <h3 className="mt-2 text-3xl font-black text-sky-600">{days}</h3>
        </div>
        ...
        <section className="mt-8 rounded-[2rem] bg-white p-6 shadow-sm ring-1 ring-slate-200">
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex h-11 items-center gap-2 rounded-xl bg-sky-50 px-4 text-sm font-black text-sky-700 hover:bg-sky-100"
            >
