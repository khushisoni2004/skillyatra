                ...
                <div className="preview-panel">
                  ...
                  >
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                      <span style={{ fontSize: 15, fontWeight: 950, color: "white" }}>
                        Readiness
                      </span>
                      <span style={{ fontSize: 34, fontWeight: 950, color: "white" }}>
                        72%
                      </span>
                    </div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginTop: 14 }}>
                  {["DSA Tracker", "Resume Coach", "Interview AI", "Companies"].map((item, index) => (
                    <div key={item} className="mini-card">
                      ...
                      />
                      <p style={{ color: "#0F172A", fontSize: 14, fontWeight: 950 }}>
                        {item}
                      </p>
                      <p style={{ marginTop: 4, color: "#0284C7", fontSize: 12, fontWeight: 900 }}>
                        Active
                      </p>
                    </div>
                  ))}
