          ...
          <div className={visible ? "enter d3" : ""} style={{ position: "relative" }}>
            <div
              style={{
                ...
                inset: -22,
                borderRadius: 46,
                background: "linear-gradient(135deg, rgba(14,165,233,0.20), rgba(125,211,252,0.34))",
                filter: "blur(36px)"
              }}
            />
            ...
            <div
              style={{
                ...
                borderRadius: 40,
                padding: 30,
                boxShadow: "0 34px 90px rgba(2,132,199,0.17)",
            ...
            >
              ...
              <div style={{ position: "relative", zIndex: 1 }}>
                ...
                >
                  Prepare smarter with a clear study system
                </h3>
                ...
                >
                  Track your study plan, solve questions, improve resume quality and prepare for interviews with one focused placement dashboard.
                </p>
                ...
                >
                  <div
                    style={{
                      ...
                      borderRadius: "50%",
                      background: "linear-gradient(135deg, #0EA5E9, #7DD3FC)",
                      boxShadow: "0 28px 60px rgba(14,165,233,0.28)"
                    }}
                  />
                  ...
                  <div
                    style={{
                      ...
                      boxShadow: "0 16px 32px rgba(2,132,199,0.12)"
                    }}
                  />
                  ...
                  <div
                    style={{
                      ...
                      background: "#FFFFFF",
                      border: "1px solid #BAE6FD",
                      boxShadow: "0 20px 42px rgba(2,132,199,0.12)"
                    }}
                  />
                  ...
                  <div
                    style={{
                      ...
                      background: "#FFFFFF",
                      border: "1px solid #BAE6FD",
                      boxShadow: "0 24px 58px rgba(2,132,199,0.14)",
                      padding: 16
                    }}
                  >
                    <div
                    ...
                    >
                      <Code2 size={42} color="#0284C7" strokeWidth={2.4} />
                    </div>
                  </div>
                  ...
                  >
                    <p style={{ color: "#0284C7", fontSize: 12, fontWeight: 950 }}>
                      DSA Practice
                    </p>
                    <p style={{ color: "#64748B", fontSize: 11, fontWeight: 750, marginTop: 3 }}>
                      Topic-wise progress
                    </p>
                  </div>
                ...
                >
                  {[
                    ["Daily Plan", "Stay consistent"],
                    ["Questions", "Practice daily"],
                    ["Interview", "Build confidence"]
                  ].map(([title, sub]) => (
                    <div
                      key={title}
                      style={{
                        ...
                        borderRadius: 20,
                        padding: 16,
                        boxShadow: "0 14px 32px rgba(2,132,199,0.08)"
                      }}
                    >
                      <p style={{ color: "#0F172A", fontSize: 13, fontWeight: 950 }}>
                        {title}
                      </p>
                      <p style={{ color: "#0284C7", fontSize: 11, fontWeight: 850, marginTop: 4 }}>
                        {sub}
                      </p>
                    </div>
                  ))}
