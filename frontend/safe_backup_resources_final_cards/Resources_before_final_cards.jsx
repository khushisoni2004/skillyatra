...
const sections = [
  {
    ...
    ,
      ...
      {
        title: "TakeUForward Premium / Plus Courses",
        subtitle: "Official TakeUForward course and premium learning page for DSA and interview prep.",
        type: "Paid Course",
        logo: LOGOS.tuf,
        url: "https://takeuforward.org/plus"
      },
      {
        title: "CodeWithHarry Courses",
        subtitle: "Programming, web development and placement-friendly course library.",
        type: "Course Platform",
        logo: LOGOS.codewithharry,
        url: "https://www.codewithharry.com/"
      },
      {
        title: "CodeHelp by Love Babbar Courses",
        subtitle: "DSA, web development and placement-focused courses by CodeHelp.",
        type: "Paid Course",
      ...
      },
      {
        ...
        subtitle: "Structured programming, DSA and web development courses.",
        type: "Paid Course",
        logo: LOGOS.apna,
        url: "https://www.apnacollege.in/"
      },
      {
        title: "Abdul Bari Courses Search",
        subtitle: "Search Abdul Bari courses and algorithm learning resources.",
        type: "Course Search",
        logo: LOGOS.abdulbari,
        url: "https://www.udemy.com/courses/search/?q=abdul%20bari"
      },
      {
        title: "GeeksforGeeks Courses",
        subtitle: "GFG courses for DSA, interview preparation, CS subjects and placement.",
        type: "Paid Course",
        logo: LOGOS.gfg,
        url: "https://www.geeksforgeeks.org/courses/"
      },
      {
        title: "Udemy Placement Courses",
        subtitle: "Search multiple paid courses for DSA, web development, React, backend and aptitude.",
        type: "Paid Course Search",
        logo: LOGOS.udemy,
        url: "https://www.udemy.com/courses/search/?q=placement%20preparation%20dsa%20web%20development"
      },
      {
        title: "Coursera Computer Science Courses",
        subtitle: "Search professional CS, software engineering and AI courses.",
        type: "Course Search",
        logo: LOGOS.coursera,
        url: "https://www.coursera.org/search?query=computer%20science%20software%20engineering"
      }
    ,

      {
        title: "HTML CSS JavaScript Full Course",
        subtitle: "Complete web development YouTube playlists for beginners and projects.",
        type: "YouTube Playlist",
        logo: LOGOS.youtube,
        url: "https://www.youtube.com/results?search_query=HTML+CSS+JavaScript+full+course+playlist"
      },
      {
        title: "Responsive Web Design Projects",
        subtitle: "Practice responsive websites and UI project building.",
        type: "YouTube Playlist",
        logo: LOGOS.youtube,
        url: "https://www.youtube.com/results?search_query=responsive+web+design+projects+playlist"
      },
      {
        title: "JavaScript Interview Practice Playlist",
        subtitle: "JavaScript questions, DOM, ES6 and interview preparation.",
        type: "YouTube Playlist",
        logo: LOGOS.youtube,
        url: "https://www.youtube.com/results?search_query=JavaScript+interview+questions+playlist"
      },
      {
        title: "Frontend Project Playlist",
        subtitle: "Frontend project tutorials useful for placement portfolio.",
        type: "YouTube Playlist",
        logo: LOGOS.youtube,
        url: "https://www.youtube.com/results?search_query=frontend+projects+html+css+javascript+playlist"
      }
    ,

      {
        title: "React Full Course Playlist",
        subtitle: "React basics, components, hooks and routing playlists.",
        type: "YouTube Playlist",
        logo: LOGOS.youtube,
        url: "https://www.youtube.com/results?search_query=React+full+course+playlist+hooks+projects"
      },
      {
        title: "React Projects Playlist",
        subtitle: "Build React projects for frontend portfolio and interviews.",
        type: "YouTube Playlist",
        logo: LOGOS.youtube,
        url: "https://www.youtube.com/results?search_query=React+projects+playlist+frontend"
      },
      {
        title: "React Interview Questions Playlist",
        subtitle: "React interview questions, hooks, lifecycle and state management.",
        type: "YouTube Playlist",
        logo: LOGOS.youtube,
        url: "https://www.youtube.com/results?search_query=React+interview+questions+playlist"
      },
      {
        title: "Redux and React Router Playlist",
        subtitle: "Redux, React Router and frontend architecture learning.",
        type: "YouTube Playlist",
        logo: LOGOS.youtube,
        url: "https://www.youtube.com/results?search_query=Redux+React+Router+playlist"
      }
    ,

      {
        title: "Node.js Express Full Course",
        subtitle: "Backend development with Node, Express and REST APIs.",
        type: "YouTube Playlist",
        logo: LOGOS.youtube,
        url: "https://www.youtube.com/results?search_query=Node.js+Express+full+course+playlist"
      },
      {
        title: "MongoDB Backend Playlist",
        subtitle: "MongoDB, Mongoose and database integration tutorials.",
        type: "YouTube Playlist",
        logo: LOGOS.youtube,
        url: "https://www.youtube.com/results?search_query=MongoDB+Mongoose+backend+playlist"
      },
      {
        title: "REST API Project Playlist",
        subtitle: "Build REST APIs with authentication and database.",
        type: "YouTube Playlist",
        logo: LOGOS.youtube,
        url: "https://www.youtube.com/results?search_query=REST+API+project+Node+Express+MongoDB+playlist"
      },
      {
        title: "Backend Interview Questions Playlist",
        subtitle: "Backend, Node.js, API, database and deployment interview prep.",
        type: "YouTube Playlist",
        logo: LOGOS.youtube,
        url: "https://www.youtube.com/results?search_query=backend+developer+interview+questions+playlist"
      }
    ,

      {
        title: "Striver DSA Playlist",
        subtitle: "DSA roadmap and problem solving playlist by Striver.",
        type: "YouTube Playlist",
        logo: LOGOS.tuf,
        url: "https://www.youtube.com/results?search_query=Striver+DSA+playlist+A2Z"
      },
      {
        title: "Love Babbar DSA Playlist",
        subtitle: "DSA placement preparation and coding sheet playlist.",
        type: "YouTube Playlist",
        logo: LOGOS.lovebabbar,
      ...
      },
      {
        ...
        subtitle: "Algorithms and data structures explained visually.",
        type: "YouTube Playlist",
        logo: LOGOS.abdulbari,
        url: "https://www.youtube.com/results?search_query=Abdul+Bari+algorithms+playlist"
      },
      {
        title: "DSA Practice Questions Playlist",
        subtitle: "Topic-wise DSA practice problems for placements.",
        type: "YouTube Playlist",
        logo: LOGOS.youtube,
    ...
    ,
      ...
      {
        title: "Gate Smashers Core CS Playlist",
        subtitle: "DBMS, OS, CN, TOC and compiler lectures.",
        type: "YouTube Playlist",
        logo: LOGOS.gatesmashers,
        url: "https://www.youtube.com/results?search_query=Gate+Smashers+DBMS+OS+CN+TOC+Compiler"
      },
      {
        title: "DBMS Interview Playlist",
        subtitle: "DBMS concepts, SQL, normalization and interview preparation.",
        type: "YouTube Playlist",
        logo: LOGOS.youtube,
        url: "https://www.youtube.com/results?search_query=DBMS+interview+questions+playlist"
      },
      {
        title: "Operating System Playlist",
        subtitle: "OS scheduling, memory, deadlock and process concepts.",
        type: "YouTube Playlist",
        logo: LOGOS.youtube,
        url: "https://www.youtube.com/results?search_query=Operating+System+playlist+interview"
      },
      {
        title: "Computer Networks Playlist",
        subtitle: "CN, OSI, TCP/IP, routing, DNS and protocols.",
        type: "YouTube Playlist",
        logo: LOGOS.youtube,
        url: "https://www.youtube.com/results?search_query=Computer+Networks+playlist+interview"
      }
    ,

      {
        title: "Machine Learning Full Course Playlist",
        subtitle: "ML concepts, algorithms and Python implementation.",
        type: "YouTube Playlist",
        logo: LOGOS.youtube,
        url: "https://www.youtube.com/results?search_query=machine+learning+full+course+playlist+python"
      },
      {
        title: "AI / ML Project Playlist",
        subtitle: "Portfolio-level AI and ML projects for resume.",
        type: "YouTube Playlist",
        logo: LOGOS.youtube,
        url: "https://www.youtube.com/results?search_query=AI+ML+projects+playlist+python"
      },
      {
        title: "Data Science Playlist",
        subtitle: "Python, Pandas, NumPy, visualization and ML basics.",
        type: "YouTube Playlist",
        logo: LOGOS.youtube,
        url: "https://www.youtube.com/results?search_query=data+science+python+playlist"
      },
      {
        title: "AI Interview Questions Playlist",
        subtitle: "ML, DL, NLP and AI interview preparation questions.",
        type: "YouTube Playlist",
        logo: LOGOS.youtube,
        url: "https://www.youtube.com/results?search_query=machine+learning+interview+questions+playlist"
      }
    ,

      {
        title: "Quantitative Aptitude Playlist",
        subtitle: "Number system, percentage, profit-loss, time-work and speed-distance.",
        type: "YouTube Playlist",
        logo: LOGOS.youtube,
        url: "https://www.youtube.com/results?search_query=quantitative+aptitude+placement+playlist"
      },
      {
        title: "Logical Reasoning Playlist",
        subtitle: "Series, blood relation, direction, seating and puzzles.",
        type: "YouTube Playlist",
        logo: LOGOS.youtube,
        url: "https://www.youtube.com/results?search_query=logical+reasoning+placement+playlist"
      },
      {
        title: "Verbal Ability Playlist",
        subtitle: "English grammar, reading comprehension and verbal aptitude.",
        type: "YouTube Playlist",
        logo: LOGOS.youtube,
        url: "https://www.youtube.com/results?search_query=verbal+ability+placement+playlist"
      },
      {
        title: "NQT Placement Aptitude Playlist",
        subtitle: "TCS NQT and campus aptitude preparation videos.",
        type: "YouTube Playlist",
        logo: LOGOS.youtube,
        url: "https://www.youtube.com/results?search_query=TCS+NQT+aptitude+playlist"
      }
    ]
  },
  {
