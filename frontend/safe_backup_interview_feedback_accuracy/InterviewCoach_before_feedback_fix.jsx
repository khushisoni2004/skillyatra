...
async function initFaceLandmarker() {
  ...
  function speakQuestion() {
    ...
    const intro = `${activeQuestion?.roundName || "Interview Round"}. Please answer formally. Maintain eye contact and sit straight. Question ${activeIndex + 1}. `;
    speakText(intro + activeQuestion.question, () => {
...
function goNext(autoSpeak = false) {
    ...
    setActiveIndex((prev) => {
      ...
      if (autoSpeak && questions[next]) {
        setTimeout(() => {
          speakText(`${questions[next].roundName || "Next round"}. Next question. ${questions[next].question}`, () => {
            if (autoMode) setTimeout(() => startListening(), 700);
          });
        }, 500);
      }
