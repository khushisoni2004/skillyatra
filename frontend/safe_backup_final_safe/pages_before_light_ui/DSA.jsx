...
export default function DSA() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-100 via-blue-100 to-indigo-100 p-6">
      <div className="mx-auto max-w-7xl space-y-6">
        <section className="rounded-[34px] bg-gradient-to-r from-indigo-600 via-violet-600 to-blue-600 p-8 text-white shadow-xl shadow-indigo-200">
          ...
          <p className="mt-3 text-sm font-semibold text-indigo-100">
            Real coding questions from dataset with topic, platform, difficulty filters and pagination.
          </p>
        </section>
        ...
        <section className="rounded-[30px] bg-white p-5 shadow-xl ring-1 ring-slate-200">
        ...
        <section className="space-y-5">
          ...
          {questions.map((q, index) => (
            <div key={q.id} className="rounded-[28px] bg-white p-6 shadow-lg ring-1 ring-slate-200">
        ...
        {totalPages > 1 && (
          <div className="flex flex-wrap items-center justify-between gap-4 rounded-[24px] bg-white p-4 shadow ring-1 ring-slate-200">
            <button
              onClick={() => {
