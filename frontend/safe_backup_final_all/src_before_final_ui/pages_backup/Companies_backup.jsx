...
export default function Companies() {
  ...
  return (
    <div className="min-h-screen bg-[#f6f8ff] px-6 py-8">
      <section className="relative overflow-hidden rounded-[34px] bg-gradient-to-br from-slate-950 via-indigo-950 to-violet-900 p-8 text-white shadow-2xl shadow-indigo-100">
          ...
          <div className="mt-3 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-4 max-w-4xl text-sm font-semibold leading-6 text-indigo-100">
                Select a company, view real dataset roles, required skills, location and role-wise preparation direction.
              </p>
            </div>
            ...
            <div className="rounded-3xl bg-white/10 p-5 backdrop-blur-xl ring-1 ring-white/15">
              ...
              <h2 className="mt-2 max-w-[260px] truncate text-2xl font-black">
      ...
      <section className="sticky top-4 z-20 mt-8 rounded-[32px] bg-white/95 p-6 shadow-xl shadow-indigo-100/60 ring-1 ring-slate-200 backdrop-blur">
        <div className="grid gap-4 xl:grid-cols-[1fr_1fr_auto] xl:items-end">
          <div>
            ...
            <input
              ...
              className="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4 text-sm font-bold text-slate-800 outline-none transition focus:border-indigo-500 focus:bg-white focus:ring-4 focus:ring-indigo-100"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4 text-sm font-bold text-slate-800 outline-none transition focus:border-indigo-500 focus:bg-white focus:ring-4 focus:ring-indigo-100"
            >
              <option value="">Select company directly</option>
              {dropdownCompanies.map((company, index) => (
                <option key={`${company.companyName}-${index}`} value={company.companyName}>
                  {company.companyName}
                </option>
              ))}
            </select>
          ...
          <button
            ...
            className="rounded-2xl bg-gradient-to-r from-indigo-600 to-violet-600 px-8 py-4 text-sm font-black text-white shadow-lg shadow-indigo-100 transition hover:scale-[1.02]"
          >
            Search →
          </button>
        </div>
      ...
      <section className="mt-8 rounded-[32px] bg-white p-6 shadow-sm ring-1 ring-slate-200">
        ...
        {!search.trim() && (
          <div className="rounded-[28px] border border-slate-200 bg-gradient-to-r from-slate-50 to-indigo-50 p-10 text-center">
        ...
        {search.trim() && searchedOnce && searchedCompanies.length > 0 && (
          <div>
            <div className="mb-4 flex flex-wrap items-center justify-between gap-4">
              <div>
                ...
                <p className="mt-1 text-sm font-semibold text-slate-500">
                  Click company to load roles. Detail page opens only from Company Detail button.
                </p>
              </div>
            ...
            <div className="overflow-x-auto rounded-[28px] border border-slate-200 bg-slate-50 p-4">
            ...
            <p className="mt-3 text-sm font-bold text-slate-500">
              Showing top {searchedCompanies.length} matching companies.
            </p>
          </div>
        )}
      </section>
      ...
      <section className="mt-8 rounded-[32px] bg-white p-6 shadow-sm ring-1 ring-slate-200">
        ...
        {!rolesViewed && (
          <div className="mt-6 rounded-[28px] border border-slate-200 bg-gradient-to-r from-slate-50 to-indigo-50 p-10 text-center">
