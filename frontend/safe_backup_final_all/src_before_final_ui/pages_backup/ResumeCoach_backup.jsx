      ...
      <div className="mx-auto w-full max-w-7xl space-y-6">
        ...
        <section className="grid gap-6 lg:grid-cols-2">
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
            ...
            <p className="mt-1 text-sm font-semibold text-slate-500">
              Upload PDF, DOCX, TXT or paste resume text manually.
            </p>
            ...
            <input
              ...
              className="mt-5 w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-semibold"
            />
            ...
            <textarea
              ...
              rows={14}
              className="mt-4 w-full resize-y rounded-2xl border border-slate-200 p-4 text-sm font-semibold text-slate-800 outline-none transition focus:border-indigo-500 focus:ring-4 focus:ring-indigo-50"
            />
