...
export default function Companies() {
  ...
  return (
    <div className="companies-theme-page min-h-screen px-6 py-8">
      <section className="companies-theme-hero relative overflow-hidden rounded-[38px] p-8 text-white">
      ...
      <section className="companies-theme-panel mt-8 rounded-[34px] p-6 backdrop-blur">
      ...
      <section className="companies-theme-panel mt-8 rounded-[34px] p-6">
        {loading && (
